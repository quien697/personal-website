...
const Heading: React.FC<HeadingProps> = ({ title }) => {
  return (
    ...
    <h2 className="w-full text-5xl text-neutral-600 dark:text-neutral-300 font-semibold opacity-10 uppercase mb-0 xl:text-9xl lg:text-8xl md:text-6xl">{title}</h2>
